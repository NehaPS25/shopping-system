...
try{
	...
	ResultSet rs = st.executeQuery("SELECT DISTINCT * FROM cart INNER JOIN Productss ON cart.product_id = Productss.id WHERE cart.email='" + email + "' AND cart.orderDate IS NOT NULL");
